 ...
 * javax.inject.Named; import java.util.List;
 * 
 * import br.com.planner.sam.model.Member;
 * 
 ...
 * 
 * // @Named provides access the return value via the EL variable name "members"
 * in the UI (e.g., // Facelets or JSP view)
 * 
 * @Produces
 * 
 * @Named public List<Member> getMembers() { return members; }
 * 
 * public void onMemberListChanged(@Observes(notifyObserver =
 * Reception.IF_EXISTS) final Member member) {
